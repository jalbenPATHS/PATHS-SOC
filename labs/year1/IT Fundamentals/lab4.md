Lab description: Students need to discover the physical location of a picture, modify the image, create an encrypted ZIP file, and finally transmit the picture and out of band key delivery.  
