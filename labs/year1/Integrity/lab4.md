Lab description: Student will setup MAC filtering on a switch port, verify it works with a USB NIC, next the student will spoof the MAC of the USB NIC and observe the results of the port security. 
